...
#pragma region Basic Setup
    ...
    GLFWwindow *window = glfwCreateWindow(WIDTH, HEIGHT, "Exercício 02", nullptr, nullptr);
...
#pragma endregion
    ...
    vaos.push_back(createTriangle(80.0f, 460.0f, 160.0f, 320.0f, 240.0f, 460.0f));
    vaos.push_back(createTriangle(280.0f, 460.0f, 360.0f, 320.0f, 440.0f, 460.0f));
    vaos.push_back(createTriangle(480.0f, 460.0f, 560.0f, 320.0f, 640.0f, 460.0f));
    vaos.push_back(createTriangle(180.0f, 220.0f, 260.0f, 80.0f, 340.0f, 220.0f));
    vaos.push_back(createTriangle(420.0f, 220.0f, 500.0f, 80.0f, 580.0f, 220.0f));

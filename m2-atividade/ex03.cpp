...
#pragma region Basic Setup
    ...
    GLFWwindow *window = glfwCreateWindow(WIDTH, HEIGHT, "Exercício 03", nullptr, nullptr);
...
#pragma endregion
    ...
    GLuint vao = createTriangle(-0.1f, -0.1f, 0.1f, -0.1f, 0.0f, 0.1f);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        if (state == GLFW_PRESS && prevMouseState == GLFW_RELEASE)
        {
            ...
            float y = 1.0f - (float)(my / HEIGHT) * 2.0f;

            Triangle t = {x, y, randomRGB(), randomRGB(), randomRGB()};
...
#pragma endregion
        ...
        {
            glm::mat4 matrix = glm::translate(glm::mat4(1), glm::vec3(t.x, t.y, 0.0f));
            glUniformMatrix4fv(glGetUniformLocation(shader_programme, "matrix"), 1, GL_FALSE, glm::value_ptr(matrix));
            glUniform3f(glGetUniformLocation(shader_programme, "uColor"), t.r, t.g, t.b);
            glBindVertexArray(vao);
